...
class MyAppointmentsComponent extends StatefulWidget {
  ...
  @override
  _MyAppointmentsComponentState createState() =>
      _MyAppointmentsComponentState();
}
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            //const SizedBox(height: 5.0),
            Text(
              widget.startTime.toString().substring(0, 2) +
                  ":" +
                  widget.startTime.toString().substring(2) +
                  ' - ' +
                  widget.endTime.toString().substring(0, 2) +
                  ":" +
                  widget.endTime.toString().substring(2),
              style: GoogleFonts.mallanna(
                color: AppColors.highlightColor,
                fontSize: 16.0,
                fontWeight: FontWeight.normal,
